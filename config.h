...
static const char *fonts[]          		= { "Fira Code:size=10", "Vazirmatn:size=10", "JoyPixels:pixelsize=14:antialias=true:autohint=true" };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask, 		XK_i,  			spawn,          SHCMD("brave   --incognito") },
